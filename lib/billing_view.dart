...
class _BillingViewState extends State<BillingView> {
  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(backgroundColor: widget.isReadOnly ? Colors.purple : Colors.blue, foregroundColor: Colors.white, title: Text(widget.party.name), 
      actions: [
