              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("₹${grandTotal.toStringAsFixed(2)}", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Colors.blue)),
                  ],
                ),
              ),
            ],
  ...
  Future<bool> _showWarning() async {
    return await showDialog(
      ...
      builder: (c) => AlertDialog(
        title: const Text("⚠️ Alert: Expiry Modified"),
        content: const Text("Aapne purane batch ki Expiry Date mein badlav kiya hai. Kya aap ise save karna chahte hain?"),
        actions: [
