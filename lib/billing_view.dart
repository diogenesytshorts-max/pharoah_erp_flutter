      ...
      body: Stack(children: [
        Column(children: [
          ...
          Expanded(child: ListView.builder(itemCount: items.length, itemBuilder: (c, i) => ListTile(
            ...
            subtitle: Text("Qty: ${items[i].qty.toInt()} | Batch: ${items[i].batch} | Exp: ${items[i].exp} | GST: ${items[i].gstRate}%"),
...
// (Note: ItemEntryForm ka code pichla hi rahega jisme MM/YY logic tha)
