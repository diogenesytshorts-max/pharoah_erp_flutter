...
class FinanceDashboard extends StatelessWidget {
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                ...
                _toolCard("PDC TRACKER", "Post Dated Cheques", Icons.Layers_outlined, Colors.teal, () {}),
  ...
  Widget _ageingBox(String label, String amt, Color c) {
    return Expanded(
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 5),
            Text(amt, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900, color: c)),
          ],
        ),
      ),
    );
  ...
  Widget _toolCard(String title, String sub, IconData icon, Color color, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(20),
      child: Container(
