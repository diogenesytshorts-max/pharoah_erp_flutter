...
class DashboardView extends StatelessWidget {
  ...
  Widget _buildMasterHubGateway(BuildContext context) => InkWell(
    ...
    child: Container(
      ...
      child: const Row(children: [
        ...
        SizedBox(width: 18),
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text("MASTER HUB", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)), Text("Manage Parties, Items, Companies, Salts & more", style: TextStyle(color: Colors.white70, fontSize: 11))])),
