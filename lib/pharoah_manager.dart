...
class PharoahManager with ChangeNotifier {
  ...
  // ===========================================================================
  // 4. 🛡️ ADVANCED SECURITY ENGINE (BIOMETRIC & AUTO-LOCK)
  // ===========================================================================
  ...
  // ===========================================================================
  // 5. 💼 BATCH & INVENTORY LOGIC (FIXED)
  // ===========================================================================

  // NAYA: Ye function Import Review Screen mang rahi hai
  void registerBatchActivity({
    ...
    if (existingIdx != -1) {
      ...
      history.add(BatchInfo(
        batch: batchNo.trim(), exp: exp, packing: packing, mrp: mrp, rate: rate, qty: 0.0, isShell: false,
      ));
    }
    save();
  }
  ...
  // ===========================================================================
  // 6. 💼 TRANSACTION FINALIZATION (SALES, PUR, CHALLAN, RETURNS)
  // ===========================================================================
