...
class PharoahManager with ChangeNotifier {
  ...
  bool isImported = false, // NAYA
}) async { 
  String finalBillNo = isImported ? "$billNo [P2P-IMP]" : billNo; // Tagging
  ...
  if (!isImported && activeCompany != null) { // Import par counter update nahi hoga
  ...
  purchases.add(Purchase(
    id: DateTime.now().toString(), internalNo: internalNo, billNo: finalBillNo, 
  ...
  void finalizeSaleChallan({
    required String challanNo, required DateTime date, required Party party, 
    required List<BillItem> items, required double total, String remarks = ""
  }) async { 
    saleChallans.add(SaleChallan(
      id: DateTime.now().toString(), 
      billNo: challanNo, 
      partyId: party.id, // Link added
      date: date, 
  ...
  void finalizePurchaseChallan({required String challanNo, required String internalNo, required DateTime date, required Party party, required List<PurchaseItem> items, required double total, String remarks = ""}) async { 
    purchaseChallans.add(PurchaseChallan(
      id: DateTime.now().toString(), 
