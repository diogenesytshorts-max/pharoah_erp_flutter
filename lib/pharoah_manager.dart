...
import 'dart:async'; // NAYA
import 'package:flutter/material.dart';
import 'package:path_provider/path_provider.dart';
import 'package:local_auth/local_auth.dart'; // NAYA
import 'package:flutter_secure_storage/flutter_secure_storage.dart'; // NAYA
...
class PharoahManager with ChangeNotifier {
  // ===========================================================================
  // 1. CLASS VARIABLES (SECURITY & NAVIGATION)
  // ===========================================================================
  
  String activeModule = "HOME"; 
  
  // --- 🛡️ NEW SECURITY & AUTO-LOCK STATE ---
  bool isAppLocked = false;           // Parda (Overlay) toggle
  Timer? _inactivityTimer;            // Countdown timer
  final _auth = LocalAuthentication(); // Fingerprint Hardware
  final _secureStorage = const FlutterSecureStorage(); // Encrypted memory
  ...
  void authenticateAdmin(bool status) { 
    ...
    if (status) {
      isAppLocked = false;
      resetInactivityTimer(); // Timer shuru
    }
    notifyListeners(); 
  }
  ...
  // ===========================================================================
  // 6. 💼 ERP BUSINESS LOGIC (RESTORED MISSING METHODS)
  // ===========================================================================
