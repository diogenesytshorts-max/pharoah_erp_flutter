...
class PurchaseItemForm extends StatefulWidget {
  ...
  @override
  State<PurchaseItemForm> createState() => _PurchaseItemFormState();
}
...
class _PurchaseItemFormState extends State<PurchaseItemForm> {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(children: [
          ...
          ElevatedButton(
              style: ElevatedButton.styleFrom(minimumSize: const Size(double.infinity, 45), backgroundColor: Colors.orange.shade800),
              onPressed: () {
  ...
  Widget _field(TextEditingController ctrl, String l, {List<TextInputFormatter>? fmt, bool en = true, Function(String)? onCh, bool isNum = false}) {
    return TextField(
        controller: ctrl,
        enabled: en,
        inputFormatters: fmt,
