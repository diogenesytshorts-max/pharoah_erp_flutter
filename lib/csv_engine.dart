...
class CsvEngine {
  // --- UNIVERSAL 37-COLUMN HEADER (Index 0 to 36) ---
  static List<String> get _universalHeader => [
    ...
    "ITEM_TOTAL", "BILL_DISC", "BILL_ROUNDOFF"
  ];
    ...
    for (var s in sales) {
      ...
      for (var i in s.items) {
        ...
        rows.add([
          ...
          maskPurchaseRate ? 0.0 : med.purRate, i.rate, i.gstRate,
          i.total, s.extraDiscount, s.roundOff
        ]);
      }
    }
