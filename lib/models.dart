...
// =====================================================================
// 1. BATCH INFO MODEL (Medicine ke purane batches yaad rakhne ke liye)
// =====================================================================
class BatchInfo {
...
// =====================================================================
// 2. MEDICINE MODEL (Product Master)
// =====================================================================
class Medicine {
  ...
  factory Medicine.fromMap(Map<String, dynamic> map) => Medicine(
    ...
    composition: map['composition'] ?? "N/A",
...
// =====================================================================
// 3. PARTY MODEL (Customer / Distributor Master)
// =====================================================================
class Party {
  ...
  Party({
    ...
    this.specialDiscount = 0.0, // Added for Rate C calculations
  });
...
// =====================================================================
// 4. BILL ITEM MODEL (Single item inside an Invoice)
// =====================================================================
class BillItem {
  ...
  BillItem({
    ...
    required this.qty,
    required this.rate,
    this.discountPercent = 0.0, // Dual Discount Support
    this.discountRupees = 0.0,  // Dual Discount Support
  ...
  Map<String, dynamic> toMap() => {
    ...
    'qty': qty, 'rate': rate, 'discountPercent': discountPercent,
    'discountRupees': discountRupees, 'gstRate': gstRate, 'cgst': cgst,
...
// =====================================================================
// 5. SALE MODEL (Full Bill / Invoice)
// =====================================================================
class Sale {
  String id, billNo, partyName, paymentMode, status; // status: Active/Cancelled
  DateTime date;
  List<BillItem> items;
  double totalAmount;
