...
class PurchasePdf {
  ...
  // --- ACTION 2: GENERATE BYTES (Required for Bulk ZIP & Router) ---
    ...
    return pw.Container(
      ...
      child: pw.Row(children: [
        pw.Container(width: 340, padding: const pw.EdgeInsets.all(5), decoration: const pw.BoxDecoration(border: pw.Border(right: pw.BorderSide(width: 0.5))), child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
          pw.Text("Amount in Words: RUPEES ${PdfMasterService.numberToWords(pur.totalAmount.round())} ONLY", style: pw.TextStyle(fontSize: 7.5, fontWeight: pw.FontWeight.bold, color: PdfColors.blue800)),
          pw.Spacer(),
          pw.Text("Note: Internal record for stock inward verification.", style: const pw.TextStyle(fontSize: 7, color: PdfColors.grey700)),
        ])),
        ...
        // FIXED: Added pw. prefix to FontWeight
